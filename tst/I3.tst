...
gap> mt := MulTab(I3,S3);;
gap> I3conjclasses := AsSet(SubSgpsByMinExtensions(mt));;
...
gap> I3conjclasses = AsSet(SubSgpsByIdeals(K33,S3));
true
gap> I3conjclasses = AsSet(SubSgpsByIdeals(K32,S3));
true
gap> I3conjclasses = AsSet(SubSgpsByIdeals(K31,S3));
true
gap> I3conjclasses = AsSet(SubSgpsByIdeals(K30,S3));
true
