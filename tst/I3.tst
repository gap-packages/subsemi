...
gap> I3conjclasses = AsSet(SubSgpsByIdeal(K33,S3));
true
gap> I3conjclasses = AsSet(SubSgpsByIdeal(K32,S3));
true
gap> I3conjclasses = AsSet(SubSgpsByIdeal(K31,S3));
true
gap> I3conjclasses = AsSet(SubSgpsByIdeal(K30,S3));
true
