...
\draw node [plain](Tn) {$\T_n$};
\draw node [plain,right of=Tn] (In) {$\I_n$};
\draw node [plain,right of=In] (Ins) {$\I_n^*$};
\draw node [plain,right of=Ins] (Br) {$\fB_n$};
\draw node [plain,below of=In] (Sn) {$\cS_n$};

\draw node [plain,below right of=Sn] (1n) {$1_n$};
\draw node [plain,below of=Br] (TemperleyLieb) {$TL_n$};
\draw node [plain,above of=Tn] (PTn) {$PT_n$};
\draw node [plain,above of=PTn] (Bin) {Bin$_n$};
\draw node [plain,above right of=Bin] (PBn) {PB$_n$};
\draw node [plain,below right of=PBn] (PartitionMonoid) {$\cP_n$};
