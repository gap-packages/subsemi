...
################################################################################
# INPUT: none
# OUTPUT: T4.subs - a file containing conjugacy class representatives of
# subsemigroups of the degree 4 full transformation semigroup stored
# in 6-packed encoding
...
XLOADER="Read(\\\"T4defs.g\\\");" #double indirection for creating scripts
