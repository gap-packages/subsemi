...
echo $LOADER"P_I4();" | gap

#subs of I43 mod I42
echo $LOADER"I43modI42subs();" | gap -q -m 7g
...
rm UTtasks;
for i in UT*; do echo "echo \"$XLOADER I43SubsFromUpperTorsos(\\\"$i\\\");\" | gap  -q -m 3g" >> UTtasks; done;
parallel < UTtasks
cat UT*M > I43.reps

echo $LOADER"I43sharp();" | gap -10g
